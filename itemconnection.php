...
{
if($rollno==$s)
 {$sql="insert into item(images_path,name,description,seller,seller_lname,branch,rollno) 
      values('$target_path','$name','$description','$seller','$seller_lname','$branch','$rollno')";
...
<h1>Your add has been posted. Click <a href="home.php">here</a>.</h1></body>';}
 else 
 {echo '<head>
<link rel="stylesheet" type="text/css" href="style.css" />
</head><body background="bg.jpg" align="middle">
<br><br><br><br><br><br><br><br><br>
<img src="logo.png" height="170px" width="190px"/><br><br>
<h1>Please enter your own roll number! Click <a href="item.php">here</a>!</h1></body>';}}
else
{echo '<head>
<link rel="stylesheet" type="text/css" href="style.css" />
</head><body background="bg.jpg" align="middle">
